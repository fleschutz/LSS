...
1️⃣ No solutions
----------------
No solution exists for: n equal 4 or 5 modulo 9. See the [no_solutions.txt](Results/no_solutions.txt) in the [📂Results](Results) folder generated by the program (for n < 100000).


2️⃣ Primitive solutions for positive numbers
--------------------------------------------
See the [primitive_solutions_for_positive_numbers.txt](Results/primitive_solutions_for_positive_numbers.txt) (text file) and [primitive_solutions_for_positive_numbers.csv](Results/primitive_solutions_for_positive_numbers.csv) (CSV file) in the Results folder generated by the program (for n < 100000 and solutions formatted to be: x <= y <= z).
