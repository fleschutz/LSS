...
-----------------------------------------------------
See the [solutions_for_negative_numbers.txt](Results/solutions_for_negative_numbers.txt) (text file) and [solutions_for_negative_numbers.csv](Results/solutions_for_negative_numbers.csv) (CSV file) in the Results folder (generated by executing: `./a.out 3`, for n < 100 000 and solutions formatted to be: x <= y <= z, took 0.037s).
