...
--------------------------
No solution exists for: n equal 4 or 5 modulo 9. See the [no_solutions.txt](Results/no_solutions.txt) in the [📂Results](Results) folder (generated by executing: `./a.out 1` for 0 <= n <= 100 000, it took 0.116s).

Mode 2 - List solutions for positive numbers of x,y,z
-----------------------------------------------------
See the [solutions_for_positive_xyz.txt](Results/solutions_for_positive_xyz.txt) (text file) and [solutions_for_positive_xyz.csv](Results/solutions_for_positive_xyz.csv) (CSV file) in the Results folder (generated by executing: `./a.out 2` for 0 <= n <= 100 000, it took 0.037s).

Mode 3 - List solutions for negative numbers of x,y,z
-----------------------------------------------------
See the [solutions_for_negative_xyz.txt](Results/solutions_for_negative_xyz.txt) (text file) and [solutions_for_negative_xyz.csv](Results/solutions_for_negative_xyz.csv) (CSV file) in the Results folder (generated by executing: `./a.out 3` for 0 <= n <= 100 000, it took 3h).

Mode 4 - List all trivial solutions
-------------------------------------
This is mode 1 + 2 + 3 combined. See the [trivial_solutions.txt](Results/trivial_solutions.txt) (text file) and [trivial_solutions.csv](Results/trivial_solutions.csv) (CSV file) in the Results folder (generated by executing: `./a.out 4`, for n < 1000 and x,y,z < 100 000 and solutions formatted to be: x <= y <= z and line-sorted afterwards).
