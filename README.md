...
Executing: `./a.out 1` (for n = [0..100000]) the resulting output is: [no_solutions.txt](Solutions/no_solutions.txt) (took 0.116s).


Mode 2 - List solutions for positive numbers of x,y,z
-----------------------------------------------------
Finding solutions for positive numbers of x,y,z only is quite fast.

Executing: `./a.out 2` (for n = [0..100000]) the resulting output is: [solutions_for_positive_xyz.txt](Solutions/solutions_for_positive_xyz.txt) (TXT file) or [solutions_for_positive_xyz.csv](Solutions/solutions_for_positive_xyz.csv) (CSV file) (took 0.037s).
...
Big numbers are supported, e.g.: `./a.out 5 -80538738812075974 80435758145817515 1260212329733563` returns: `3982933876681³ + -636600549515³ + -3977505554546³ = 30`.
